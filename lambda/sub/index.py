...
def lambda_handler(event, context):
    ...
    print(conn)
    conn = psycopg2.connect(dbname="aims_bi_dev", user="aimsbi-dev", password="Aimsbi0123", port=5439,host="redshift-cluster-1.cekwuxvn8umt.us-east-1.redshift.amazonaws.com")
    print(conn)
    cur = conn.cursor()
